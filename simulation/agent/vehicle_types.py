...
from simulation.agent.dummy_driver import DummyDriver
from simulation.agent.intelligent_driver import IntelligentDriver
from simulation.agent.vehicle import Vehicle
...
class Truck(Vehicle):
    ...
    def __init__(self):
        super(Truck, self).__init__(mesh=[Vector2(1.25, 6.0), Vector2(-1.25, 6.0),
                                    ...
                                    max_velocity=22, max_acceleration=2.0)
...
class Minivan(Vehicle):
    ...
    def __init__(self):
        super(Minivan, self).__init__(mesh=[Vector2(1.0, 2.5), Vector2(-1.0, 2.5),
                                      ...
                                      max_velocity=30, max_acceleration=3.5)
...
class Sportscar(Vehicle):
    ...
    def __init__(self):
        super(Sportscar, self).__init__(mesh=[Vector2(0.7, 2.0), Vector2(-0.7, 2.0),
                                        ...
                                        max_velocity=42, max_acceleration=6.0)
